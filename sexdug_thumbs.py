...
class SantaEvent(gC.rssImageExtractor):
    ...
    def streamtape(self,response):
        ...
        for artrticle in response.css('div.videos-list>article.loop-video'): 
            all_img_links.append(artrticle.css('div.post-thumbnail-container>img::attr(data-src)').get())
            all_img_name.append(artrticle.css('div.post-thumbnail-container>img::attr(alt)').get())
